...
with st.spinner(
    ...
    try:
        ...
        st.error(
            f"Erro ao executar o Pipeline: {exc}"
        )

        info(
            f"Erro no Dashboard ao executar Pipeline: {exc}"
        )
...
st.write(
    ...
    pelo motor quantitativo do OddReal com base nos
    indicadores matemáticos e nas condições do mercado.
    """
)
